...
import { CANDIDATE_01_FIRST_THREE_CHAPTERS_CAMPAIGN } from '../../content/candidate-01';
import { Candidate01CampaignController } from '../campaign-game';
...
describe('candidate-01 campaign UI', () => {
  ...
  it('moves from novel presentation to a persistent choice and battle staging', () => {
    const controller = new Candidate01CampaignController(null, () => {});
