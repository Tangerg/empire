...
import { CANDIDATE_01_CONTENT_PACK } from './candidate-01';

/** Explicit application composition root; importing core alone installs nothing. */
export function installDefaultContent(): string[] {
  return installContentPacks(COMMON_CONTENT_PACK, ANCIENT_EMPIRES_CONTENT_PACK, CANDIDATE_01_CONTENT_PACK);
}
